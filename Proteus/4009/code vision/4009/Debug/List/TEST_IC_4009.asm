...
_main:
; .FSTART _main
; 0000 0047     DDRA    = 0x5f ; // 0101 1111
	LDI  R30,LOW(95)
	OUT  0x1A,R30
; 0000 0048     PORTA   = 0xa0 ; // 1010 0000
	LDI  R30,LOW(160)
	OUT  0x1B,R30
; 0000 0049 
; 0000 004A     DDRD    = 0xdf ; // 1101 1111
	LDI  R30,LOW(223)
	OUT  0x11,R30
; 0000 004B     PORTD   = 0x20 ; // 0010 0000
	LDI  R30,LOW(32)
	OUT  0x12,R30
; 0000 004C 
; 0000 004D     DDRC    = 0xdf ; // 1101 1111
	LDI  R30,LOW(223)
	OUT  0x14,R30
; 0000 004E     PORTC   = 0x20 ; // 0010 0000
	LDI  R30,LOW(32)
	OUT  0x15,R30
; 0000 004F 
; 0000 0050     DDRB    = 0xfa ; // 1111 1010
	LDI  R30,LOW(250)
	OUT  0x17,R30
; 0000 0051     PORTB   = 0x05 ; // 0000 0101
	LDI  R30,LOW(5)
	OUT  0x18,R30
; 0000 0052 
; 0000 0053     vcc = ON;
...
; 0000 0063                 delay_ms(50);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 0064                 if( G == !A && H == !B && I == !C && J == !D && K== !E &&  L==!F ){
	RCALL SUBOPT_0x0
	BRNE _0x20
	RCALL SUBOPT_0x1
	BRNE _0x20
...
_0x20:
	RJMP _0x1F
_0x21:
; 0000 0065                     LED_GREEN = ON;
	SBI  0x12,2
; 0000 0066                     delay_ms(200);
	LDI  R26,LOW(200)
	LDI  R27,0
	CALL _delay_ms
; 0000 0067                     LED_GREEN = OFF;
	CBI  0x12,2
; 0000 0068                     test = ON;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0069                 }
; 0000 006A                 else if( G != !A && H != !B && I != !C && J != !D && K!= !E &&  L!=!F ){
	RJMP _0x26
_0x1F:
	RCALL SUBOPT_0x0
	BREQ _0x28
...
_0x28:
	RJMP _0x27
_0x29:
; 0000 006B                     LED_RED = ON;
	SBI  0x12,3
; 0000 006C                     delay_ms(200);
	LDI  R26,LOW(200)
	LDI  R27,0
	CALL _delay_ms
; 0000 006D                     LED_RED = OFF;
	CBI  0x12,3
; 0000 006E                     test = OFF;
	CLR  R5
; 0000 006F                     //break;
...
_0x26:
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 0072                 for(i1=0;i1<6;i1++){
	CLR  R7
_0x2F:
	LDI  R30,LOW(6)
	CP   R7,R30
	BRSH _0x30
; 0000 0073                     if(arr1[i1]== 1){
	RCALL SUBOPT_0x6
	LD   R26,Z
	CPI  R26,LOW(0x1)
	BRNE _0x31
...
; 0000 0082               LED_RED = OFF;
	CBI  0x12,3
; 0000 0083               LED_GREEN = ON;
	SBI  0x12,2
; 0000 0084         }
; 0000 0085         else if(test == 0){
	RJMP _0x3B
_0x36:
	TST  R5
	BRNE _0x3C
; 0000 0086             LED_GREEN = OFF;
	CBI  0x12,2
